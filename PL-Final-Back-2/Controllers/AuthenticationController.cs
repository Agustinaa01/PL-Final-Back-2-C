...
namespace Agenda_Tup_Back.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        //};
            ...
            claimsForToken.Add(new Claim("given_email", user.Email)); //Lo mismo para given_name y family_name, son las convenciones para nombre y apellido. Ustedes pueden usar lo que quieran, pero si alguien que no conoce la app
